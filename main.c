...
//GAME MAP
int aMap[iMapSizeY][iMapSizeX]={0};
int aMapCreation[iMapSizeY][iMapSizeX]={0};
...
//------------------------------------\\\GAME LOGIC\\\------------------------------------//
	...
	//VERIFY CURRENT SCREEN
        ...
        {
            case TITLE:{if(IsKeyPressed(KEY_SPACE)||IsGestureDetected(GESTURE_TAP)){eCurrentScreen=GAMEPLAY;}else if(IsKeyPressed(KEY_M)){eCurrentScreen=MAPCREATION;}else if(IsKeyPressed(KEY_ESCAPE)){bGameLoop=0;}}break;
            case GAMEPLAY:
            {
...
//------------------------------------///PLAYER MOVEMENT///------------------------------//
            ...
            case GAMEOVER:{if(IsKeyPressed(KEY_SPACE)||IsGestureDetected(GESTURE_TAP)){eCurrentScreen=GAMEPLAY;}else if(IsKeyPressed(KEY_M)){eCurrentScreen=MAPCREATION;}}break;
            case MAPCREATION:{if(IsKeyPressed(KEY_ESCAPE)){eCurrentScreen=TITLE;}}break;
            default:break;
	}
